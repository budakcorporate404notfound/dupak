...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://pixinvent.com/materialize-material-design-admin-template/app-assets/css/pages/forgot.min.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css"
...
<body
    class="vertical-layout page-header-light vertical-menu-collapsible vertical-menu-nav-dark preload-transitions 1-column forgot-bg   blank-page blank-page"
                    ...
                    <div class="col s12 m6 l4 z-depth-4 offset-m4 card-panel border-radius-6 forgot-card bg-opacity-8">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <h5 class="ml-4">Verify Your Email Address</h5>

                                <p class="ml-4">Before proceeding
                                    <br>
                                    please check your email for a verification link</p>

                                <p class="ml-4">If you did not receive the email
                                ...
                                <form id="myform" class="d-inline" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <button type="submit"
                                                class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12 mb-1">click
